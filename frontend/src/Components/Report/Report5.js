...
const Report5 = () => {
  ...
  const handlePreview = async () => {
    try {
      const response = await axios.get(
        `http://localhost:8000/api/records/search-by-possession/?possessionStatus=${selectedProof}`
      );
    ...
    try {
      ...
      const tableRows = fetchedRecords
        ...
        <tr style="background-color: ${
          ...
          <td style="border: 1px solid #dee2e6; padding: 12px 16px; background-color: green; color: white; font-weight: bold;">${
  ...
  return (
    <div style={styles.container}>
      <label style={styles.label}>የይዞታ የተገኘበት ሁኔታ</label>
      <select
              ...
              <table style={styles.previewTable}>
                <thead>
                  <tr>
                    ...
                    <th style={styles.tableHeader}>የይዞታ የተገኘበት ሁኔታ</th>
                  </tr>
                </thead>
                <tbody>
